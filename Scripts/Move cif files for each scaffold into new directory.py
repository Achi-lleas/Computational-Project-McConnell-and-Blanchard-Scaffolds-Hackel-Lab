...
This is a simple script that will be used to transfer all the .cif files of the 20 seeds #0 generated by AlphaFold3 for each of the Blanchard et al. and McConnell et al. scaffolds into a new directory. 
